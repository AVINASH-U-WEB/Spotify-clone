...
import { assets } from '../assets/assets'; // Ensure the import path and object are correct
    ...
    <div className='w-[25%] h-full p-2 flex flex-col gap-2 text-white hidden lg:flex'>
        ...
        <div className='bg-[#121212] h-[85%] rounded'>
            <div className='p-4 flex items-center justify-between'>
                ...
                <div className='flex items-center gap-3'>
                    <img src={assets.arrow_icon} className='w-5' alt="Arrow Icon" />
                    <img src={assets.plus_icon} className='w-5' alt="Plus Icon" />
                </div>
            </div>
